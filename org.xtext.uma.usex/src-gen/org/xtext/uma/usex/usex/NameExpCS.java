 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.uma.usex.usex.NameExpCS#getOwnedPathName <em>Owned Path Name</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.NameExpCS#getOwnedSquareBracketedClauses <em>Owned Square Bracketed Clauses</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.NameExpCS#getOwnedRoundBracketedClause <em>Owned Round Bracketed Clause</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.NameExpCS#getOwnedCurlyBracketedClause <em>Owned Curly Bracketed Clause</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.NameExpCS#isIsPre <em>Is Pre</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.NameExpCS#isPre <em>Pre</em>}</li>
 * </ul>
 *
 * @see org.xtext.uma.usex.usex.UsexPackage#getNameExpCS()
 * @model
 * @generated
 */
public interface NameExpCS extends ExpCS
{
   ...
   * @see org.xtext.uma.usex.usex.UsexPackage#getNameExpCS_OwnedPathName()
  ...
  /**
   * Sets the value of the '{@link org.xtext.uma.usex.usex.NameExpCS#getOwnedPathName <em>Owned Path Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.xtext.uma.usex.usex.SquareBracketedClauseCS}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Owned Square Bracketed Clauses</em>' containment reference list.
   * @see org.xtext.uma.usex.usex.UsexPackage#getNameExpCS_OwnedSquareBracketedClauses()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.xtext.uma.usex.usex.UsexPackage#getNameExpCS_OwnedRoundBracketedClause()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.uma.usex.usex.NameExpCS#getOwnedRoundBracketedClause <em>Owned Round Bracketed Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.uma.usex.usex.UsexPackage#getNameExpCS_OwnedCurlyBracketedClause()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.uma.usex.usex.NameExpCS#getOwnedCurlyBracketedClause <em>Owned Curly Bracketed Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.uma.usex.usex.UsexPackage#getNameExpCS_IsPre()
   * @model
   * @generated
   */
  boolean isIsPre();
  ...
  /**
   * Sets the value of the '{@link org.xtext.uma.usex.usex.NameExpCS#isIsPre <em>Is Pre</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setPre(boolean)
   * @see org.xtext.uma.usex.usex.UsexPackage#getNameExpCS_Pre()
   * @model
   * @generated
   */
  boolean isPre();
  ...
  /**
   * Sets the value of the '{@link org.xtext.uma.usex.usex.NameExpCS#isPre <em>Pre</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
