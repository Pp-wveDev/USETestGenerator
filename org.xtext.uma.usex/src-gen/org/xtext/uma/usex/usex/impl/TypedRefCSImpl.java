 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.uma.usex.usex.impl.TypedRefCSImpl#getOwnedMultiplicity <em>Owned Multiplicity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypedRefCSImpl extends MinimalEObjectImpl.Container implements TypedRefCS
{
  ...
  {
    return UsexPackage.Literals.TYPED_REF_CS;
  }
  ...
  public NotificationChain basicSetOwnedMultiplicity(MultiplicityCS newOwnedMultiplicity, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.TYPED_REF_CS__OWNED_MULTIPLICITY, oldOwnedMultiplicity, newOwnedMultiplicity);
  ...
  public void setOwnedMultiplicity(MultiplicityCS newOwnedMultiplicity)
  {
    if (newOwnedMultiplicity != ownedMultiplicity)
    {
      ...
      if (ownedMultiplicity != null)
        msgs = ((InternalEObject)ownedMultiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.TYPED_REF_CS__OWNED_MULTIPLICITY, null, msgs);
      if (newOwnedMultiplicity != null)
        msgs = ((InternalEObject)newOwnedMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.TYPED_REF_CS__OWNED_MULTIPLICITY, null, msgs);
      msgs = basicSetOwnedMultiplicity(newOwnedMultiplicity, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.TYPED_REF_CS__OWNED_MULTIPLICITY, newOwnedMultiplicity, newOwnedMultiplicity));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UsexPackage.TYPED_REF_CS__OWNED_MULTIPLICITY:
