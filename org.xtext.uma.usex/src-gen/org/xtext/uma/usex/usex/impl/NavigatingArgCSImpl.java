 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.uma.usex.usex.impl.NavigatingArgCSImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.NavigatingArgCSImpl#getOwnedNameExpression <em>Owned Name Expression</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.NavigatingArgCSImpl#getSymbolT <em>Symbol T</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.NavigatingArgCSImpl#getOwnedType <em>Owned Type</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.NavigatingArgCSImpl#getSymbolIE <em>Symbol IE</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.NavigatingArgCSImpl#getOwnedInitExpression <em>Owned Init Expression</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.NavigatingArgCSImpl#getSymbolCI <em>Symbol CI</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.NavigatingArgCSImpl#getOwnedCoIterator <em>Owned Co Iterator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NavigatingArgCSImpl extends MinimalEObjectImpl.Container implements NavigatingArgCS
{
  ...
  {
    return UsexPackage.Literals.NAVIGATING_ARG_CS;
  }
  ...
  public void setPrefix(String newPrefix)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__PREFIX, oldPrefix, prefix));
  }
  ...
  public NotificationChain basicSetOwnedNameExpression(ExpCS newOwnedNameExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION, oldOwnedNameExpression, newOwnedNameExpression);
  ...
  public void setOwnedNameExpression(ExpCS newOwnedNameExpression)
  {
    if (newOwnedNameExpression != ownedNameExpression)
    {
      ...
      if (ownedNameExpression != null)
        msgs = ((InternalEObject)ownedNameExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION, null, msgs);
      if (newOwnedNameExpression != null)
        msgs = ((InternalEObject)newOwnedNameExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION, null, msgs);
      msgs = basicSetOwnedNameExpression(newOwnedNameExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION, newOwnedNameExpression, newOwnedNameExpression));
  }
  ...
  public void setSymbolT(String newSymbolT)
  {
    ...
    symbolT = newSymbolT;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__SYMBOL_T, oldSymbolT, symbolT));
  }
  ...
  public NotificationChain basicSetOwnedType(TypedRefCS newOwnedType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__OWNED_TYPE, oldOwnedType, newOwnedType);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOwnedType(TypedRefCS newOwnedType)
  {
    if (newOwnedType != ownedType)
    {
      NotificationChain msgs = null;
      if (ownedType != null)
        msgs = ((InternalEObject)ownedType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.NAVIGATING_ARG_CS__OWNED_TYPE, null, msgs);
      if (newOwnedType != null)
        msgs = ((InternalEObject)newOwnedType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.NAVIGATING_ARG_CS__OWNED_TYPE, null, msgs);
      msgs = basicSetOwnedType(newOwnedType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__OWNED_TYPE, newOwnedType, newOwnedType));
  }
  ...
  public void setSymbolIE(String newSymbolIE)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__SYMBOL_IE, oldSymbolIE, symbolIE));
  }
  ...
  public NotificationChain basicSetOwnedInitExpression(ExpCS newOwnedInitExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION, oldOwnedInitExpression, newOwnedInitExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOwnedInitExpression(ExpCS newOwnedInitExpression)
  {
    if (newOwnedInitExpression != ownedInitExpression)
    {
      ...
      if (ownedInitExpression != null)
        msgs = ((InternalEObject)ownedInitExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION, null, msgs);
      if (newOwnedInitExpression != null)
        msgs = ((InternalEObject)newOwnedInitExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION, null, msgs);
      msgs = basicSetOwnedInitExpression(newOwnedInitExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION, newOwnedInitExpression, newOwnedInitExpression));
  }
  ...
  public void setSymbolCI(String newSymbolCI)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__SYMBOL_CI, oldSymbolCI, symbolCI));
  }
  ...
  public NotificationChain basicSetOwnedCoIterator(VariableCS newOwnedCoIterator, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR, oldOwnedCoIterator, newOwnedCoIterator);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOwnedCoIterator(VariableCS newOwnedCoIterator)
  {
    if (newOwnedCoIterator != ownedCoIterator)
    {
      ...
      if (ownedCoIterator != null)
        msgs = ((InternalEObject)ownedCoIterator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR, null, msgs);
      if (newOwnedCoIterator != null)
        msgs = ((InternalEObject)newOwnedCoIterator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR, null, msgs);
      msgs = basicSetOwnedCoIterator(newOwnedCoIterator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR, newOwnedCoIterator, newOwnedCoIterator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UsexPackage.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION:
        return basicSetOwnedNameExpression(null, msgs);
      case UsexPackage.NAVIGATING_ARG_CS__OWNED_TYPE:
        return basicSetOwnedType(null, msgs);
      case UsexPackage.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION:
        return basicSetOwnedInitExpression(null, msgs);
      case UsexPackage.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UsexPackage.NAVIGATING_ARG_CS__PREFIX:
        return getPrefix();
      case UsexPackage.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION:
        return getOwnedNameExpression();
      case UsexPackage.NAVIGATING_ARG_CS__SYMBOL_T:
        return getSymbolT();
      case UsexPackage.NAVIGATING_ARG_CS__OWNED_TYPE:
        return getOwnedType();
      case UsexPackage.NAVIGATING_ARG_CS__SYMBOL_IE:
        return getSymbolIE();
      case UsexPackage.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION:
        return getOwnedInitExpression();
      case UsexPackage.NAVIGATING_ARG_CS__SYMBOL_CI:
        return getSymbolCI();
      case UsexPackage.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR:
