 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.uma.usex.usex.impl.LambdaLiteralExpCSImpl#getOwnedExpressionCS <em>Owned Expression CS</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LambdaLiteralExpCSImpl extends ExpCSImpl implements LambdaLiteralExpCS
{
  ...
  {
    return UsexPackage.Literals.LAMBDA_LITERAL_EXP_CS;
  }
  ...
  public NotificationChain basicSetOwnedExpressionCS(ExpCS newOwnedExpressionCS, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.LAMBDA_LITERAL_EXP_CS__OWNED_EXPRESSION_CS, oldOwnedExpressionCS, newOwnedExpressionCS);
  ...
  public void setOwnedExpressionCS(ExpCS newOwnedExpressionCS)
  {
    if (newOwnedExpressionCS != ownedExpressionCS)
    {
      ...
      if (ownedExpressionCS != null)
        msgs = ((InternalEObject)ownedExpressionCS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.LAMBDA_LITERAL_EXP_CS__OWNED_EXPRESSION_CS, null, msgs);
      if (newOwnedExpressionCS != null)
        msgs = ((InternalEObject)newOwnedExpressionCS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.LAMBDA_LITERAL_EXP_CS__OWNED_EXPRESSION_CS, null, msgs);
      msgs = basicSetOwnedExpressionCS(newOwnedExpressionCS, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.LAMBDA_LITERAL_EXP_CS__OWNED_EXPRESSION_CS, newOwnedExpressionCS, newOwnedExpressionCS));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UsexPackage.LAMBDA_LITERAL_EXP_CS__OWNED_EXPRESSION_CS:
