 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.uma.usex.usex.impl.CollectionPatternCSImpl#getOwnedType <em>Owned Type</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.CollectionPatternCSImpl#getOwnedParts <em>Owned Parts</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.CollectionPatternCSImpl#getRestVariableName <em>Rest Variable Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionPatternCSImpl extends TypedRefCSImpl implements CollectionPatternCS
{
  ...
  {
    return UsexPackage.Literals.COLLECTION_PATTERN_CS;
  }
  ...
  public NotificationChain basicSetOwnedType(CollectionTypeCS newOwnedType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.COLLECTION_PATTERN_CS__OWNED_TYPE, oldOwnedType, newOwnedType);
  ...
  public void setOwnedType(CollectionTypeCS newOwnedType)
  {
    if (newOwnedType != ownedType)
    {
      ...
      if (ownedType != null)
        msgs = ((InternalEObject)ownedType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.COLLECTION_PATTERN_CS__OWNED_TYPE, null, msgs);
      if (newOwnedType != null)
        msgs = ((InternalEObject)newOwnedType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.COLLECTION_PATTERN_CS__OWNED_TYPE, null, msgs);
      msgs = basicSetOwnedType(newOwnedType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.COLLECTION_PATTERN_CS__OWNED_TYPE, newOwnedType, newOwnedType));
  }
  ...
  public EList<PatternExpCS> getOwnedParts()
  {
    if (ownedParts == null)
    {
      ownedParts = new EObjectContainmentEList<PatternExpCS>(PatternExpCS.class, this, UsexPackage.COLLECTION_PATTERN_CS__OWNED_PARTS);
    }
    return ownedParts;
  }
  ...
  public void setRestVariableName(String newRestVariableName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.COLLECTION_PATTERN_CS__REST_VARIABLE_NAME, oldRestVariableName, restVariableName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UsexPackage.COLLECTION_PATTERN_CS__OWNED_TYPE:
        return basicSetOwnedType(null, msgs);
      case UsexPackage.COLLECTION_PATTERN_CS__OWNED_PARTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case UsexPackage.COLLECTION_PATTERN_CS__REST_VARIABLE_NAME:
