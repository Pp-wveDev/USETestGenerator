 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.uma.usex.usex.impl.PatternExpCSImpl#getPatternVariableName <em>Pattern Variable Name</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.PatternExpCSImpl#getOwnedPatternType <em>Owned Pattern Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatternExpCSImpl extends MinimalEObjectImpl.Container implements PatternExpCS
{
  ...
  {
    return UsexPackage.Literals.PATTERN_EXP_CS;
  }
  ...
  public void setPatternVariableName(String newPatternVariableName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.PATTERN_EXP_CS__PATTERN_VARIABLE_NAME, oldPatternVariableName, patternVariableName));
  }
  ...
  public NotificationChain basicSetOwnedPatternType(TypedRefCS newOwnedPatternType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, oldOwnedPatternType, newOwnedPatternType);
  ...
  public void setOwnedPatternType(TypedRefCS newOwnedPatternType)
  {
    if (newOwnedPatternType != ownedPatternType)
    {
      ...
      if (ownedPatternType != null)
        msgs = ((InternalEObject)ownedPatternType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, null, msgs);
      if (newOwnedPatternType != null)
        msgs = ((InternalEObject)newOwnedPatternType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, null, msgs);
      msgs = basicSetOwnedPatternType(newOwnedPatternType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, newOwnedPatternType, newOwnedPatternType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UsexPackage.PATTERN_EXP_CS__OWNED_PATTERN_TYPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UsexPackage.PATTERN_EXP_CS__PATTERN_VARIABLE_NAME:
