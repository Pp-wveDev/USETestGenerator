 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.uma.usex.usex.impl.ShadowPartCSImpl#getReferredProperty <em>Referred Property</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.ShadowPartCSImpl#getOwnedInitExpression <em>Owned Init Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShadowPartCSImpl extends MinimalEObjectImpl.Container implements ShadowPartCS
{
  ...
  {
    return UsexPackage.Literals.SHADOW_PART_CS;
  }
  ...
  public void setReferredProperty(String newReferredProperty)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.SHADOW_PART_CS__REFERRED_PROPERTY, oldReferredProperty, referredProperty));
  }
  ...
  public NotificationChain basicSetOwnedInitExpression(EObject newOwnedInitExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, oldOwnedInitExpression, newOwnedInitExpression);
  ...
  public void setOwnedInitExpression(EObject newOwnedInitExpression)
  {
    if (newOwnedInitExpression != ownedInitExpression)
    {
      ...
      if (ownedInitExpression != null)
        msgs = ((InternalEObject)ownedInitExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, null, msgs);
      if (newOwnedInitExpression != null)
        msgs = ((InternalEObject)newOwnedInitExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, null, msgs);
      msgs = basicSetOwnedInitExpression(newOwnedInitExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, newOwnedInitExpression, newOwnedInitExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UsexPackage.SHADOW_PART_CS__OWNED_INIT_EXPRESSION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UsexPackage.SHADOW_PART_CS__REFERRED_PROPERTY:
