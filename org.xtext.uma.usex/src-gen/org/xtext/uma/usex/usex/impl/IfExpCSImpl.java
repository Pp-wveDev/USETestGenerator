 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.uma.usex.usex.impl.IfExpCSImpl#getOwnedCondition <em>Owned Condition</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.IfExpCSImpl#getOwnedThenExpression <em>Owned Then Expression</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.IfExpCSImpl#getOwnedIfThenExpressions <em>Owned If Then Expressions</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.IfExpCSImpl#getOwnedElseExpression <em>Owned Else Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfExpCSImpl extends ExpCSImpl implements IfExpCS
{
  ...
  {
    return UsexPackage.Literals.IF_EXP_CS;
  }
  ...
  public NotificationChain basicSetOwnedCondition(EObject newOwnedCondition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.IF_EXP_CS__OWNED_CONDITION, oldOwnedCondition, newOwnedCondition);
  ...
  public void setOwnedCondition(EObject newOwnedCondition)
  {
    if (newOwnedCondition != ownedCondition)
    {
      ...
      if (ownedCondition != null)
        msgs = ((InternalEObject)ownedCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.IF_EXP_CS__OWNED_CONDITION, null, msgs);
      if (newOwnedCondition != null)
        msgs = ((InternalEObject)newOwnedCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.IF_EXP_CS__OWNED_CONDITION, null, msgs);
      msgs = basicSetOwnedCondition(newOwnedCondition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.IF_EXP_CS__OWNED_CONDITION, newOwnedCondition, newOwnedCondition));
  }
  ...
  public NotificationChain basicSetOwnedThenExpression(ExpCS newOwnedThenExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.IF_EXP_CS__OWNED_THEN_EXPRESSION, oldOwnedThenExpression, newOwnedThenExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOwnedThenExpression(ExpCS newOwnedThenExpression)
  {
    if (newOwnedThenExpression != ownedThenExpression)
    {
      ...
      if (ownedThenExpression != null)
        msgs = ((InternalEObject)ownedThenExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.IF_EXP_CS__OWNED_THEN_EXPRESSION, null, msgs);
      if (newOwnedThenExpression != null)
        msgs = ((InternalEObject)newOwnedThenExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.IF_EXP_CS__OWNED_THEN_EXPRESSION, null, msgs);
      msgs = basicSetOwnedThenExpression(newOwnedThenExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.IF_EXP_CS__OWNED_THEN_EXPRESSION, newOwnedThenExpression, newOwnedThenExpression));
  }
  ...
  public EList<IfThenExpCS> getOwnedIfThenExpressions()
  {
    ...
    {
      ownedIfThenExpressions = new EObjectContainmentEList<IfThenExpCS>(IfThenExpCS.class, this, UsexPackage.IF_EXP_CS__OWNED_IF_THEN_EXPRESSIONS);
    }
  ...
  public NotificationChain basicSetOwnedElseExpression(ExpCS newOwnedElseExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.IF_EXP_CS__OWNED_ELSE_EXPRESSION, oldOwnedElseExpression, newOwnedElseExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOwnedElseExpression(ExpCS newOwnedElseExpression)
  {
    if (newOwnedElseExpression != ownedElseExpression)
    {
      ...
      if (ownedElseExpression != null)
        msgs = ((InternalEObject)ownedElseExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.IF_EXP_CS__OWNED_ELSE_EXPRESSION, null, msgs);
      if (newOwnedElseExpression != null)
        msgs = ((InternalEObject)newOwnedElseExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.IF_EXP_CS__OWNED_ELSE_EXPRESSION, null, msgs);
      msgs = basicSetOwnedElseExpression(newOwnedElseExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.IF_EXP_CS__OWNED_ELSE_EXPRESSION, newOwnedElseExpression, newOwnedElseExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UsexPackage.IF_EXP_CS__OWNED_CONDITION:
        return basicSetOwnedCondition(null, msgs);
      case UsexPackage.IF_EXP_CS__OWNED_THEN_EXPRESSION:
        return basicSetOwnedThenExpression(null, msgs);
      case UsexPackage.IF_EXP_CS__OWNED_IF_THEN_EXPRESSIONS:
        return ((InternalEList<?>)getOwnedIfThenExpressions()).basicRemove(otherEnd, msgs);
      case UsexPackage.IF_EXP_CS__OWNED_ELSE_EXPRESSION:
