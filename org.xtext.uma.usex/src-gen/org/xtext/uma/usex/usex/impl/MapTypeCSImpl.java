 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.uma.usex.usex.impl.MapTypeCSImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.MapTypeCSImpl#getOwnedKeyType <em>Owned Key Type</em>}</li>
 *   <li>{@link org.xtext.uma.usex.usex.impl.MapTypeCSImpl#getOwnedValueType <em>Owned Value Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapTypeCSImpl extends TypedRefCSImpl implements MapTypeCS
{
  ...
  {
    return UsexPackage.Literals.MAP_TYPE_CS;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.MAP_TYPE_CS__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetOwnedKeyType(TypedRefCS newOwnedKeyType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.MAP_TYPE_CS__OWNED_KEY_TYPE, oldOwnedKeyType, newOwnedKeyType);
  ...
  public void setOwnedKeyType(TypedRefCS newOwnedKeyType)
  {
    if (newOwnedKeyType != ownedKeyType)
    {
      ...
      if (ownedKeyType != null)
        msgs = ((InternalEObject)ownedKeyType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.MAP_TYPE_CS__OWNED_KEY_TYPE, null, msgs);
      if (newOwnedKeyType != null)
        msgs = ((InternalEObject)newOwnedKeyType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.MAP_TYPE_CS__OWNED_KEY_TYPE, null, msgs);
      msgs = basicSetOwnedKeyType(newOwnedKeyType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.MAP_TYPE_CS__OWNED_KEY_TYPE, newOwnedKeyType, newOwnedKeyType));
  }
  ...
  public NotificationChain basicSetOwnedValueType(TypedRefCS newOwnedValueType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UsexPackage.MAP_TYPE_CS__OWNED_VALUE_TYPE, oldOwnedValueType, newOwnedValueType);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOwnedValueType(TypedRefCS newOwnedValueType)
  {
    if (newOwnedValueType != ownedValueType)
    {
      ...
      if (ownedValueType != null)
        msgs = ((InternalEObject)ownedValueType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UsexPackage.MAP_TYPE_CS__OWNED_VALUE_TYPE, null, msgs);
      if (newOwnedValueType != null)
        msgs = ((InternalEObject)newOwnedValueType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UsexPackage.MAP_TYPE_CS__OWNED_VALUE_TYPE, null, msgs);
      msgs = basicSetOwnedValueType(newOwnedValueType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UsexPackage.MAP_TYPE_CS__OWNED_VALUE_TYPE, newOwnedValueType, newOwnedValueType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UsexPackage.MAP_TYPE_CS__OWNED_KEY_TYPE:
        return basicSetOwnedKeyType(null, msgs);
      case UsexPackage.MAP_TYPE_CS__OWNED_VALUE_TYPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UsexPackage.MAP_TYPE_CS__NAME:
        return getName();
      case UsexPackage.MAP_TYPE_CS__OWNED_KEY_TYPE:
