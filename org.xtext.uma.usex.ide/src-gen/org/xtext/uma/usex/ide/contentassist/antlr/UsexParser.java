...
public class UsexParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, UsexGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRelationAccess().getRelationTypeAlternatives_0_0(), "rule__Relation__RelationTypeAlternatives_0_0");
			...
			builder.put(grammarAccess.getGeneralConstraintAccess().getGroup(), "rule__GeneralConstraint__Group__0");
			...
			builder.put(grammarAccess.getModelAccess().getGeneralConstraintsAssignment_3_1(), "rule__Model__GeneralConstraintsAssignment_3_1");
			builder.put(grammarAccess.getGeneralConstraintAccess().getContextClassAssignment_1(), "rule__GeneralConstraint__ContextClassAssignment_1");
			builder.put(grammarAccess.getGeneralConstraintAccess().getNameAssignment_3(), "rule__GeneralConstraint__NameAssignment_3");
			...
			builder.put(grammarAccess.getCollectionTypeAccess().getColTypeAssignment_0(), "rule__CollectionType__ColTypeAssignment_0");
			builder.put(grammarAccess.getCollectionTypeAccess().getObjTypeAssignment_2(), "rule__CollectionType__ObjTypeAssignment_2");
			...
			builder.put(grammarAccess.getMethodAccess().getOperationBodyAssignment_5(), "rule__Method__OperationBodyAssignment_5");
			builder.put(grammarAccess.getMethodAccess().getConditionsAssignment_6(), "rule__Method__ConditionsAssignment_6");
			builder.put(grammarAccess.getMethodBodyAccess().getCodeAssignment_1(), "rule__MethodBody__CodeAssignment_1");
			...
			builder.put(grammarAccess.getPreconditionAccess().getConditionBodyAssignment_3(), "rule__Precondition__ConditionBodyAssignment_3");
			builder.put(grammarAccess.getPostconditionAccess().getNameAssignment_1(), "rule__Postcondition__NameAssignment_1");
			builder.put(grammarAccess.getPostconditionAccess().getConditionBodyAssignment_3(), "rule__Postcondition__ConditionBodyAssignment_3");
			builder.put(grammarAccess.getConstraintAccess().getNameAssignment_1(), "rule__Constraint__NameAssignment_1");
			builder.put(grammarAccess.getConstraintAccess().getConstraintBodyAssignment_3(), "rule__Constraint__ConstraintBodyAssignment_3");
			builder.put(grammarAccess.getRelationAccess().getRelationTypeAssignment_0(), "rule__Relation__RelationTypeAssignment_0");
			builder.put(grammarAccess.getRelationAccess().getNameAssignment_1(), "rule__Relation__NameAssignment_1");
			builder.put(grammarAccess.getRelationAccess().getRelationBodyAssignment_3(), "rule__Relation__RelationBodyAssignment_3");
