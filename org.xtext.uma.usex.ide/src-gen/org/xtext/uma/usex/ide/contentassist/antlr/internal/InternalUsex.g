...
:
	(
		{ before(grammarAccess.getMethodAccess().getOperationBodyExpCSParserRuleCall_5_1_0()); }
		ruleExpCS
		{ after(grammarAccess.getMethodAccess().getOperationBodyExpCSParserRuleCall_5_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
